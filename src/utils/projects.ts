...
export const projects: Project[] = [
  {
    ...
    overview: [
      'This is the site you are looking at right now. I built it to host my projects and give recruiters a single URL to share in applications.',
      ...
      'I chose a dark-only theme with a sky-blue accent. The color palette uses Tailwind slate scale for text and sky-400 for the accent, which passes WCAG AAA contrast on the dark background.',
    ],
    tech: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'React Router', 'Phosphor Icons'],
    features: [
      'Single-page scroll with hash anchor navigation',
      'Sidebar with IntersectionObserver scroll-spy active states',
      'Mobile hamburger menu with 75% width overlay and click-outside-to-close',
      'Project detail pages with React Router dynamic routes',
      'Responsive layout tested at 320px, 768px, and 1024px breakpoints',
    ],
    lessons: [
